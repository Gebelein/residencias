...
class Institucion(models.Model):
    ...
    OtrosContactos = models.TextField('Otros Contactos')
    class Meta:
...
class ResidenciaAut(models.Model):
   ...
   # content_object = generic.GenericForeignKey("content_type", "object_id")
    ...
    jefeResidentes = models.CharField('Jefe de Residentes',max_length=50)
    fechaEvaluacColMed = DateField('Fecha de Evaluación en Colegio Médico')
    fechaEvaluacMixta = DateField('Fecha de Evaluación Mixta')
    fechaCeseActividad = DateField('Fecha de cese de evaluación')
    jefeServicio = models.CharField('Jefe de Servicio',max_length=50)
    coordinador = models.CharField('Coordinador',max_length=50)
    asesorDocente = models.CharField('Asesor Docente', max_length=50)
